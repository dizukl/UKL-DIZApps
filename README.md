...
<div style="width: 100%"><img alt="Image of FHIR Search query settings" title="FHIR Search query settings" src="doc/doc001.png" width=300 align=left /></div>

Query results are opened in separate browser tabs/windows.

<div style="width: 100%"><img alt="Image of query result example" title="Query result example" src="doc/doc002.png" width=300 align=left /></div>
